            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                ...
                <div>
                    ...
                    >
                        ...
                        <FeatherIcon icon="chevrons-left" className="h-5 w-5" aria-hidden="true" />
                    </PageButton>
                    <PageButton
                    ...
                    >
                        ...
                        <FeatherIcon icon="chevron-left" className="h-5 w-5" aria-hidden="true" />
                    </PageButton>
                    <PageButton
                        onClick={() => nextPage()}
                        ...
                        <FeatherIcon icon="chevron-right" className="h-5 w-5" aria-hidden="true" />
                    </PageButton>
                    <PageButton
                    ...
                    >
                        ...
                        <FeatherIcon icon="chevrons-right" className="h-5 w-5" aria-hidden="true" />
                    </PageButton>
                    </nav>
                </div>
            </div>
                ...
                <div className="py-2 align-middle inline-block min-w-full">
                    ...
                    <table {...getTableProps()} className="min-w-full divide-y divide-gray-200">
                        ...
                        {page.map((row, i) => {  // new
                            prepareRow(row)
                            return (
                            <tr {...row.getRowProps()} className="hover:bg-gray-50 cursor-pointer transition" 
